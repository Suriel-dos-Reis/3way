...
// Exercício 10//
// Lê a estação
let estacao = prompt("Digite uma estação do ano:"); 

// Converte para minúsculas
estacao = estacao.toLowerCase();

if (estacao === "verão" || estacao === "verao") {
  console.log("Estação do sol");
} else if (estacao === "primavera") {
  console.log("Estação das flores");
} else if (estacao === "inverno") {
  console.log("Estação do frio");
} else if (estacao === "outono") {
  console.log("Estação das frutas");
} else {
  console.log("Estação inválida, tente novamente!");
}
...
switch (estacao) {
  case "verão":
  case "verao": // aceita com ou sem acento
    console.log("Estação do sol");
    break;
